            ...
            <section className="relative bg-blue-500 text-white py-20">
                <div className="container mx-auto px-6 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold">
                        About <span className="text-yellow-300">ShopNow</span>
                    </h1>
            ...
            <section className="bg-white py-16">
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        <div className="md:w-1/2">
                            <p className="text-lg text-gray-600">
                                Our team at ShopNow consists of passionate book enthusiasts, curators, and tech experts who work together to bring you the best books and the most seamless shopping experience possible. We are committed to providing exceptional service and making every book lover’s journey a memorable one.
                            </p>
                        </div>
                        <div className="md:w-1/2">
                            <img
            ...
            <section className="relative bg-gradient-to-r from-blue-500 to-blue-700 text-white py-16">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-lg mb-8">
                        Whether you’re a casual reader or a book enthusiast, ShopNow has something special for you. Start exploring our collection today and embark on your next literary adventure.
                    </p>
                    <Link to='/contact-us'>
